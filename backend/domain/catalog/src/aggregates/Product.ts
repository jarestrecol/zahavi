...
import { ProductId, ProductVariantId, CategoryId } from '../value-objects/ids.js';
...
export class Product {
  ...
  eliminarVariante(
    ...
    if (nuevasVariantes.length === 0) return err(new ProductoSinVariantesError(this.id.toString()));
  ...
  activar(ahora: FechaHora, eventoId: string): Result<Product, ProductoYaEnEstadoError> {
