...
export class Margen {
  ...
  static calcular(precioVenta: Money, costoUnitario: Money): Result<Margen, MoneyInvalidoError> {
    ...
    const porcentaje = precioVenta.esCero() ? 0 : (monto.toCop() / precioVenta.toCop()) * 100;
